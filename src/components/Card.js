...
//  }
  ...
  generateCard() {
    ...
    this._numberLikes = this._element.querySelector('.card__stroke-number');
  ...
  showLike() {
    if (this.likedCard(this._userId)) {
      this._strokeButton.classList.add('card__stroke_active')
    } else {
      this._strokeButton.classList.remove('card__stroke_active')
    }
  }
